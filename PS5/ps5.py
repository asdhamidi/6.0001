    ...
    def is_phrase_in(self, text):
        ...
        for punc in string.punctuation:
            if punc in phrase:
                ...
                self.phrase = self.phrase.replace(punc, " ")
        ...
        self.phrase = refinephrase

        if self.phrase in refinetext:
            return True
        else:
            return False
...
# Problem 4
def DescriptionTrigger(PhraseTrigger):
    def evaluate(self, story):
